...
- "Help me get up and running with Batect": deeper [getting started tutorial](/docs/getting-started/tutorial) and [installation instructions](/docs/getting-started/installation), as well as conceptual explanations
